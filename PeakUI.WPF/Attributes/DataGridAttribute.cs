...
namespace PeakUI.WPF
{
    ...
    /// DataGrid 帮助类
    /// </summary>
    public static class DataGridAttribute
    {
        public static readonly DependencyProperty SelectBackgroundProperty = DependencyProperty.RegisterAttached("SelectBackground", typeof(Brush), typeof(DataGridAttribute), new PropertyMetadata(default(Brush)));
        ...
        public static Brush GetSelectBackground(DependencyObject element)
        {
        ...
        internal static readonly DependencyProperty IsHeaderSelectCheckBoxProperty = DependencyProperty.RegisterAttached(
            "IsHeaderSelectCheckBox", typeof(bool), typeof(DataGridAttribute), new PropertyMetadata(default(bool), OnIsHeaderSelectCheckBoxChanged));
        ...
        public static readonly DependencyProperty ClickToEditProperty = DependencyProperty.RegisterAttached(
            "ClickToEdit", typeof(bool), typeof(DataGridAttribute), new PropertyMetadata(default(bool), OnClickToEditChanged));
        ...
        public static readonly DependencyProperty ApplyDataAnnotationsProperty = DependencyProperty.RegisterAttached(
            "ApplyDataAnnotations", typeof(bool), typeof(DataGridAttribute), new PropertyMetadata(false, OnApplyDataAnnotationsChanged));
