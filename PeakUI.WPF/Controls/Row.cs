...
namespace PeakUI.WPF
{
    public class Row : Panel
    {
        ...
        public static readonly DependencyProperty GutterProperty = DependencyProperty.Register(
            nameof(Gutter), typeof(double), typeof(Row), new PropertyMetadata(PeakUI.WPF.Model.ValueBoxes.Double0Box, null, OnGutterCoerce), ValidateHelper.IsInRangeOfPosDoubleIncludeZero);
